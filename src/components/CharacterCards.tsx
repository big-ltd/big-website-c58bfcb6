    ...
    <div className="relative">
      ...
      >
        {characters.map((character, index) => (
          <div 
            key={index}
            className="character-card flex-shrink-0 snap-start rounded-3xl overflow-hidden"
            style={{ 
          ...
          >
            ...
            {/* Character text */}
            <div className="p-6">
              <p className="text-base font-semibold text-gray-700 leading-relaxed text-center">
                {character.text}
              </p>
            </div>
          </div>
